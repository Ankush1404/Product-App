...
<body class="text-white" background="${pageContext.request.contextPath}/resources/images/check.jpg">
     ...
     <main class="form-signin mt-5">
          ...
          <form action="${pageContext.request.contextPath}/handleUpdateChecking" method="post">

               <h1 class="h3 mb-3 mt-5 fw-normal text-center">Confirm Owner</h1>

               <input class="mb-3" type="hidden" value="${userLogInId}" name="userLogInId" />
               ...
               <p><small>Email with which you are sign in.</small></p>
